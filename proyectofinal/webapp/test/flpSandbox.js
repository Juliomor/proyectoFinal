		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#alightproyectofinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alightproyectofinal-display": {
								"semanticObject": "alightproyectofinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alight.proyectofinal",
									"url": sap.ui.require.toUrl("alight/proyectofinal")
								}
							}
						}
					}
